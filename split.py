...
def split_files(source_folder, train_ratio=0.8):
    ...
    if len(all_files) < 2:
        raise ValueError("Not enough files to split. The source folder must contain at least 2 files.")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Split files in a folder into train and test sets.")
    parser.add_argument("-source", type=str, required=True, help="The path to the source folder containing the files to split.")
